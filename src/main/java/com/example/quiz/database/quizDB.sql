...
CREATE OR REPLACE TYPE TABLAK_TYPE IS VARRAY(10) OF VARCHAR2(30);
/
DECLARE
    C NUMBER;
    TABLAK TABLAK_TYPE := TABLAK_TYPE('ALTEMA', 'FELTESZI', 'JATSZIK', 'KERDES', 'QUIZ', 'PONTSZAM', 'TEMA', 'VALASZ', 'JATEKOS', 'JATEKOS_LOG');
...
(	 "FELHASZNALONEV" VARCHAR2(30 BYTE) PRIMARY KEY NOT NULL,
     ...
     FOREIGN KEY (TEMAJA) REFERENCES TEMA(NEV) ON DELETE SET NULL
);
...
(	 "ID" NUMBER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1) PRIMARY KEY NOT NULL,
     ...
     FOREIGN KEY (ALTEMA) REFERENCES ALTEMA(NEV) ON DELETE SET NULL
);
...
(	 "VALASZID" NUMBER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1) PRIMARY KEY NOT NULL,
     ...
     "HELYESE" CHAR(1),
     FOREIGN KEY (KERDESID) REFERENCES KERDES(ID) ON DELETE SET NULL
);
...
CREATE TABLE "JATEKOS_LOG" ( LOGDATUM DATE, LOGFELHASZNALO VARCHAR2(30), LOGUZENET VARCHAR2(50));
...
CREATE OR REPLACE TRIGGER JATEKOS_LOG_TRIGGER
    ...
    ON JATEKOS
DECLARE
    VALTOZTATAS VARCHAR2(50);
BEGIN
    IF INSERTING THEN
        VALTOZTATAS := 'Játekos hozzáadva!';
    ELSIF UPDATING THEN
        VALTOZTATAS := 'Játékos frissítve!';
    ELSIF DELETING THEN
        VALTOZTATAS := 'Játékos törölve!';
    END IF;
...
INSERT INTO pontszam(FNEV, TNEV, RANGSORPONTSZAM) VALUES ('lehel', 'History', 99);
INSERT INTO pontszam(FNEV, TNEV, RANGSORPONTSZAM) VALUES ('pista', 'History', 1);
INSERT INTO pontszam(FNEV, TNEV, RANGSORPONTSZAM) VALUES ('pista', 'Movies', 15);
INSERT INTO pontszam(FNEV, TNEV, RANGSORPONTSZAM) VALUES ('pista', 'History', 33);
INSERT INTO pontszam(FNEV, TNEV, RANGSORPONTSZAM) VALUES ('pista', 'Science', 84);
INSERT INTO pontszam(FNEV, TNEV, RANGSORPONTSZAM) VALUES ('rebeka', 'History', 95);
INSERT INTO pontszam(FNEV, TNEV, RANGSORPONTSZAM) VALUES ('laci', 'Science', 97);
INSERT INTO pontszam(FNEV, TNEV, RANGSORPONTSZAM) VALUES ('laci', 'History', 96);
...
Insert INTO felteszi  VALUES (16, 4);
Insert INTO felteszi  VALUES (18, 4);
Insert INTO felteszi  VALUES (14, 4);
Insert INTO felteszi  VALUES (19, 4);
Insert INTO felteszi  VALUES (50, 5);
Insert INTO felteszi  VALUES (51, 5);
Insert INTO felteszi  VALUES (52, 5);
Insert INTO felteszi  VALUES (53, 5);
Insert INTO felteszi  VALUES (54, 5);
...
INSERT INTO jatszik VALUES('rebeka', 5);
INSERT INTO jatszik VALUES('kornel', 6);
INSERT INTO jatszik VALUES('istvan', 7);
INSERT INTO jatszik VALUES('laci', 8);
